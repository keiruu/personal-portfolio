...
function Project(props) {
    ...
    return (
        <a href={props.link} rel="noreferrer" target="_blank">
            <div className='group flex gap-6 rounded-3xl border-2 border-lightgray transition-all cursor-pointer hover:border-darkgreen px-8 py-12 justify-center max-w-[1000px]'>
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-12 my-32">
        <div className="flex flex-col gap-12 mb-20">
            <div>
                <h1 className='font-bold text-primary text-4xl'>Projects I&apos;ve worked on</h1>
            </div>
